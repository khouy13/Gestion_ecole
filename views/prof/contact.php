            ...
            <div class="row mb-5 lesson-block">
                ...
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-center flex-wrap">
                        <div class="mb-3">
                            <div class="block-service d-flex flex-column justify-content-evenly text-center m-2 border p-2 bg-white rounded" style="height: 200px; width:300px;">
                                <h4 class="fw-bold mb-4 mt-2" style="color:var(--dark-blue);">Attestation de service </h4>
                        ...
                        <div class="mb-3">
                            <div class="block-service d-flex flex-column justify-content-evenly text-center m-2 border p-2 bg-white rounded" style="height: 200px; width:300px;">
                                <h4 class="fw-bold mb-4 mt-2" style="color:var(--dark-blue);">Congés et autorisations d'absence</h4>
                                <form action="AddService" method="post">
                        ...
                        <div class="mb-3">
                            <div class="block-service d-flex flex-column justify-content-evenly text-center m-2 border p-2 bg-white rounded" style="height: 200px; width:300px;">
                                <h4 class="fw-bold mb-4 mt-2" style="color:var(--dark-blue);">Autorisations de recherche ou de publication</h4>
                                <form action="AddService" method="post">
                        ...
                        <div class="mb-3">
                            <div class="block-service d-flex flex-column justify-content-evenly text-center m-2 border p-2 bg-white rounded" style="height: 200px; width:300px;">
                                <h4 class="fw-bold mb-4 mt-2" style="color:var(--dark-blue);">Demandes de rattrapage des séances </h4>
                                <form action="AddService" method="post">
    ...
    <section class="nv-block col-12 p-5 rounded border disabled-block overflow-hidden lesson-block " style="background-color: #eeeeee;">
        ...
        <div class="row m-0 container-fluid">
            <?php foreach ($demandes as $service) { ?>
                ...
                <div class="col-4 col-lg-3 bg-white text-center bdr"><?= $service['service_date'] ?></div>
