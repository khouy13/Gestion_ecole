...
$modules = $module->getModulesOfUserOfSemestre($semestre);
$footer_color = "#eeeeee";
?>
<?php $title = "Modules" ?>
<?php ob_start(); ?>
...
<div class="container" style="margin-top: 100px;">
    <h1 class="fs-1 fw-bold mt-5 mb-5 text-center" style="color:var(--main-color);">Modules</h1>
    <div class="d-flex my-2 w-25">
    ...
    <div class="row justify-content-center text-center">
        <?php foreach ($modules as $module) { ?>
            <div class="note-card col-lg-3 col-md-4 col-10 m-2 py-5 px-2">
                <h4 class="fw-bold text-start" style="color: #296090"><?= $module['prof_name'] ?></h4>
                <h5 class="mt-4"><?= $module['module_name'] ?></h5>
